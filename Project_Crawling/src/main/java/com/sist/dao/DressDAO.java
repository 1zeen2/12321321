 ...
 */
   public void dressInsert (DressVO vo) {
      try {
         getConnection();
         String sql="INSERT INTO dress(d_no, d_image, d_subject, d_price, d_content, d_delivery, d_return_exchange, d_detail_image)"
         ...
         ps.setString(6, vo.getD_delivery());
         ps.setString(7, vo.getD_return_exchange());
         ps.setString(8, vo.getD_detail_image());
